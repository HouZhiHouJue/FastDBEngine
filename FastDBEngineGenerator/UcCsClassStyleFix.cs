...
namespace FastDBEngineGenerator
{
    public partial class UcCsClassStyleFix : UserControl
    {
        ...
        public CsClassStyle GetCsClassStyle()
        {
            ...
            {
                MemberStyle = this.radioButton1.Checked ? CsClassMemberStyle.Field : (this.radioButton2.Checked ? CsClassMemberStyle.AutoProperty : CsClassMemberStyle.ClassicProperty),
                SupportWCF = this.chkWCF.Checked,
                SortByName = this.chkSortByName.Checked,
                SupportEF = this.ckEF.Checked
            };
        }
    }
}
